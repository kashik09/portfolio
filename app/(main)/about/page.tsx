  ...
  return (
    <div className="space-y-16 py-12">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-xl text-blue-600 font-medium">{content?.hero?.nickname || 'Kashi'}</p>
      ...
      <section className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg">
          {content?.story?.map((paragraph: any, index: number) => (
            <p key={paragraph.id || index} className="text-gray-700 leading-relaxed mb-4">
              {paragraph.content}
            </p>
          ))}
        </div>
          ...
          {content?.skills?.map((category: any) => {
            ...
            return (
              <div
                ...
                className="bg-white p-6 rounded-2xl border border-gray-200 hover:border-blue-500 transition-colors"
              >
      ...
      <section>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {content?.timeline?.map((item: any, index: number) => (
            ...
            >
              <div className="absolute left-0 top-0 w-4 h-4 -translate-x-[9px] bg-blue-600 rounded-full border-4 border-blue-600"></div>
        ...
        <div className="flex items-center justify-center gap-4">
          {content?.social?.github && (
            <a
              ...
              className="p-4 bg-white rounded-full border border-gray-200 hover:border-blue-500 transition-colors"
            >
